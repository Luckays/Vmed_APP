...
const Kunzak=() => {
    ...
    useEffect(() => {
        ActualPost("kunzak_all_table",'teplota',Date.now(),setchartTeplotaData,setchartTeplotaLabels);
        ActualPost("kunzak_all_table",'tlak',Date.now(),setchartTlakData,setchartTlakLabels);
