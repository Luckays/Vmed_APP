...
const Kunzak=() => {
    ...
    useEffect(() => {
        ActualPost("kunzak_txt_table",'teplota',Date.now(),setchartTeplotaData,setchartTeplotaLabels);
        ActualPost("kunzak_txt_table",'tlak',Date.now(),setchartTlakData,setchartTlakLabels);
        ActualPost("kunzak_txt_table",'vlhkost',Date.now(),setchartVlhkostData,setchartVlhkostLabels);
        VariablePost("kunzak_txt_table","teplota","tlak","vlhkost",Date.now(),setTeplota,setTlak,setVlhkost,setDate);
