    ...
    return (
        <div className="h-100">
            ...
            <p>Geodetická observatoř Pecný je experimentálním pracovištěm Výzkumného útvaru
                ...
                gravimetrů a geodetických přístrojů a základna pro kalibraci GNSS techniky.
                Hlavní náplní observatoře je provádění permanentní GPS observace, obsluha
                ...
                a geodynamiky.
                Většina prováděných pozorování se neobejde bez oprav z prostředí. Měření je
                ...
                do země, do laboratoří či do kanceláří.
                V současné době je na observatoři přibližně 82 čidel sdružených do několika
